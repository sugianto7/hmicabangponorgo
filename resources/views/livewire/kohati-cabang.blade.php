        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="page-banner-cont">
                    <h2>KOHATI Cabang Ponorogo</h2>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Artikel & Opini</li>
                        </ol>
                    </nav>
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="section-title mt-50">
                    ...
                    <h4>KOHATI Cabang Ponorogo {{$img->priode->name}}</h4>
                </div> <!-- section title -->
                <div class="about-cont">
                    <div class="singel-teachers mt-30 text-center">
                        ...
                        <div class="cont">
                            <a href=""><h6>SRTUKTUR PENGURUS KOHATI CABANG PONOROGO</h6></a>
                       ...
                       <div class="col-lg-12">
                           <div class="saidbar-post" style="padding: 20px 0 20px;">
                            ...
                            <div class="products-btn text-right">
                                <a href="{{route('artikel.kategory',['category_slug'=>$ktg->slug]) }}" class="main-btn">Tentang Kohati</a>
                                <a href="{{route('artikel.kategory',['category_slug'=>$ktg->slug]) }}" class="main-btn">Kegiatan</a>
                            </div> <!-- products btn -->
                            @endforeach
                               <ul>
                                @foreach ($kohatis as $kohati)
                                   <li style="border-bottom: 3px solid #d2d2d2; padding-bottom: 5px;">
                                        <a href="">
                                            <div class="singel-post">
                                               <div class="thum" style="width: 68px;">
                                                   <img src="{{asset('assets/images/artikel')}}/{{$kohati->image }}" alt="artikel">
                                                </div>
                                               <div class="cont" style="padding-left: 5px;">
                                                   <h6>{{$kohati->jabatan}}</h6>
                                                   <p>{{$kohati->name}}</p>
                                                   <span>{{$kohati->Ket}}</span>
                                               </div>
                                           </div> <!-- singel post -->
                                        </a>
                                   </li>
