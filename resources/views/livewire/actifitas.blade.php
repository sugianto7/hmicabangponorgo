...
@section("title")
<meta property="og:title" content="Pers | {{$kegiatan->name}}">
@endsection
@section("meta")
    
<meta property="og:site_name" content="{{$kegiatan->name}}">
<meta property="og:title" content="Pers | {{$kegiatan->name}}" />
<meta property="og:description" content="{{$kegiatan->short_description}}" />
<meta property="og:image" itemprop="image" content="{{asset('assets/images/artikel')}}/{{$kegiatan->image }}">
            ...
            <div class="col-xs-12 col-sm-6 col-md-8">
                <article class="post pb-3">
                  <div class="entry-content" style="padding-bottom: 0;">
                    <h4 class="entry-title mt-0"><a href="#" style="text-align: justify;">{{$kegiatan->name}} </a></h4>
                    <ul class="list-inline font-12 mb-2 mt-10">
                      <li><i class="fa fa-calendar text-theme-color-2 mr-1"></i> {{$kegiatan->updated_at}} WIB </li>
                    ...
                    <div class="mt-10 mb-0">
                        ...
                        <ul class="styled-icons icon-circled m-0">
                          <li><a href="whatsapp://send?text=https://hmiponorogo.or.id/{{$kegiatan->slug}}" data-action="share/whatsapp/share" data-bg-color="#48c257"><i class="fa fa-whatsapp text-white"></i></a></li>
                          <li><a href="https://www.facebook.com/sharer/sharer.php?u=https://hmiponorogo.or.id/{{$kegiatan->slug}}" data-action="share/facebook/share" data-bg-color="#3A5795"><i class="fa fa-facebook text-white"></i></a></li>
                          <li><a href="instagram://send?text=https://hmiponorogo.or.id/{{$kegiatan->slug}}" data-action="share/instagram/share" data-bg-color="#A11312"><i class="fa fa-instagram text-white"></i></a></li>
                        </ul>
                      </div>
                  </div>
                  ...
                  <div class="entry-content">
                    <div class="post-thumb">
                     <img class="img-fullwidth img-responsive" src="{{asset('assets/images/artikel')}}/{{$kegiatan->image }}" alt=""> 
                    </div>
                    
                    <!-- <ul class="list-inline font-12 mb-20 mt-10">
                      <li><i class="fa fa-user text-theme-color-2 mr-1"></i> <b>Penulis</b> : <a href=""> </a></li>|
                      <li><i class="fa fa-pencil text-theme-color-2 ml-1 mr-1"></i> <b>Editor :</b> ddddd</li>
                    </ul> -->
                    <p class="font-11" align="justify">{!! $kegiatan->description !!}</p>
                    
                    <div class="mt-30 mb-0">
                        <h5 class="pull-left flip mt-10 mr-20 text-theme-colored">Share:</h5>
                        <ul class="styled-icons icon-circled m-0">
                          <li><a href="whatsapp://send?text=http://hmiponorogo.or.id/{{$kegiatan->slug}}" data-action="share/whatsapp/share" data-bg-color="#48c257"><i class="fa fa-whatsapp text-white"></i></a></li>
                          <li><a href="https://www.facebook.com/sharer/sharer.php?u=https://hmiponorogo.or.id/{{$kegiatan->slug}}" data-action="share/facebook/share" data-bg-color="#3A5795"><i class="fa fa-facebook text-white"></i></a></li>
                          <li><a href="instagram://send?text=https://hmiponorogo.or.id/{{$kegiatan->slug}}" data-action="share/instagram/share" data-bg-color="#A11312"><i class="fa fa-instagram text-white"></i></a></li>
                        </ul>
                      </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="share text-right flip">
                          <p><a href="whatsapp://send?text=http://hmiponorogo.or.id/{{$kegiatan->slug}}" data-action="share/whatsapp/share"> <i class="fa fa-share-alt text-theme-colored"></i> Share</a></p>
                        </div>
                      </div>
                    </div>
                </div>
                        ...
                        <div class="section-title text-center">
                          <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                              <h2 class="mt-0 pb-0 mb-0 text-white text-uppercase">Photo <span class="text-theme-color-2">Gallery Kegitan HMI</span></h2>
                            </div>
                          </div>
                        </div>
