<div class="content-wrapper">
  <div class="page-header">
    <h3 class="page-title">
      ...
      </span> LAPMI HMI <i class="mdi mdi-chevron-double-right"></i><a href="">Struktur Kepengurusan</a>
    </h3>
  </div>
  <div>
    <div class="row">
        ...
        <div class="col-lg-8">
          <div class="card mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
              <h6 class="m-0 font-weight-bold text-primary">LAPMI HMI Cabang Ponorogo</h6>
            ...
            <div class="table-responsive p-3">
              <table class="table table-bordered">
                ...
                <tbody>
                       @foreach ($lapmies as $no => $lapmi)
                  <tr>
                    <td>{{$no + $lapmies ->firstItem() }}</td>
                    <td><img src="{{asset('assets/images/artikel')}}/{{$lapmi->image }}" style="width: 60px; border-radius: 1px;"></td>
                    <td>{{$lapmi->name}}</td>
                    <td>{{$lapmi->jabatan}}</td>
                    <td>
                        <button wire:click="edit({{ $lapmi->id }})" class="btn btn-sm btn-outline-primary" data-toggle="modal" data-target="#exmpleModal1"><i class="fa fa-edit"></i> Edit</button> 
                        <botton onclick="confirm('serius ingin menghapus p Berita ....?') || event.stopImediatePropagation()" wire:click="delete({{ $lapmi->id }})" class="btn btn-sm btn-outline-danger"><i class="fa fa-trash"></i> Hapus</botton>
                    </td>
                  </tr>
                   @endforeach
                </tbody>
        ...
        <div class="col-lg-4">
          <div class="card mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
              <h6 class="m-0 font-weight-bold text-primary">Struktur Pengurus LAPMI</h6>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #0e5a12; color: white;">
                    <h5 class="modal-title" id="exampleModalLabelLogout">Tambah Tentang Lapmi</h5>
                ...
                <form enctype="multipart/form-data">
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="validationServer01">Nama Pengurus LAPMI HMI</label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control is-valid" id="validationServer01"placeholder="Keterangan Jabatan lapmi" wire:model="ket" >
            ...
            <div class="modal-content">
                ...
                <form enctype="multipart/form-data">
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="validationServer01">Nama Pengurus LAPMI HMI</label>
                            <input type="hidden" wire:model="lapmi_id">
                            <input type="text" class="form-control is-valid" id="validationServer01" placeholder="Judul Tentang" required wire:model="name">
                            @error('name') <span class="text-danger">{{ $message }}</span>@enderror
                        </div>
                        <div class="form-group">
